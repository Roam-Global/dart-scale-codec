library scalecodec_test.address_refl_test;

import 'package:convert/convert.dart';
import 'package:scalecodec/scalecodec.dart';
import 'package:test/test.dart';

import 'address_refl_test.reflectable.dart';
...
Future<String> decode(String b58Str) async {
  var a = await Address.fromJson(b58Str);
...
void main() {
  ...
  test('test decode', () {
    expect(decode('14HSB7tpJf17F1XXzC1GUiPH6c6g9UvTkKC4w4edX8vKte84'),
  ...
  test('test encode', () {
    expect(
        encode(
            'e92adb4530de173812e9a3516fe844ba94d9050f5444719290422389785ed349'),
